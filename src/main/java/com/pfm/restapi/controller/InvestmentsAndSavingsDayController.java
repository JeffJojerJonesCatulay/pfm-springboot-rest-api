...
public class InvestmentsAndSavingsDayController {
    ...
    private static final Logger log = LoggerFactory.getLogger(InvestmentsAndSavingsDayController.class);
    ...
    @GetMapping("/get/investmentsandsavingsday")
    public ResponseEntity<Object> getInvestmentsAndSavingsDay(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "5") int size,
            @RequestParam(defaultValue = "id") String sortBy,
            HttpServletRequest httpServletRequest) {
        String endPoint = httpServletRequest.getServerName() + URL + "/get/investmentsandsavingsday";
        try {
            ...
            Page<InvestmentsAndSavingsDay> data = investmentsAndSavingsDayService.getInvestmentsAndSavingsDay(pageable);
    ...
    @PostMapping("/investmentsandsavingsday/create/")
    public ResponseEntity<Object> createInvestmentsAndSavingsDay(@RequestBody InvestmentsAndSavingsDay investmentsAndSavingsDay, HttpServletRequest httpServletRequest) {
        String endPoint = httpServletRequest.getServerName() + URL + "/investmentsandsavingsday/create/";
        try {
            tps.start(endPoint, " POST METHOD | " + investmentsAndSavingsDay.getAllocId());
            log.debug("{} API - Start", endPoint);

            inputSanitation.sanitizeInput(investmentsAndSavingsDay.getDate());
            inputSanitation.sanitizeInput(investmentsAndSavingsDay.getAddedBy());
            ...
            String elapsedTime = tps.end(endPoint, " POST METHOD | " + investmentsAndSavingsDay.getAllocId(), "HTTP STATUS: " + httpStatusReturn + " | STATUS : " + httpStatusMsgReturn);
            ...
            requestLogs.setRequestMethod(new Exception().getStackTrace()[0].getMethodName());
            requestLogs.setEndpoint(endPoint);
            requestLogs.setRequestDetails(investmentsAndSavingsDay.toString());
            requestLogs.setRequestResponse(Objects.requireNonNull(body).toString());
            requestLogs.setStatusCode(Integer.parseInt(httpStatusReturn.replaceAll("\\D+", "")));
            requestLogs.setStatusResponse(httpStatusMsgReturn);
            requestLogs.setTimestamp((String) body.get("timestamp"));
            ...
            log.debug("POST METHOD | {} | HTTP STATUS: {} | STATUS : {}", investmentsAndSavingsDay.getAllocId(), httpStatusReturn, httpStatusMsgReturn);
            log.debug("{} API - End", endPoint);
        }
    ...
    @PutMapping("/investmentsandsavingsday/update/{id}")
    public ResponseEntity<Object> updateInvestmentsAndSavingsDay(@PathVariable Long id, @RequestBody InvestmentsAndSavingsDay investmentsAndSavingsDay, HttpServletRequest httpServletRequest) {
        String endPoint = httpServletRequest.getServerName() + URL + "/investmentsandsavingsday/update/" + id;
        try {
            ...
            Optional<InvestmentsAndSavingsDay> existing = investmentsAndSavingsDayService.findById(id);
            if (existing.isEmpty()) {
                httpStatusReturn = String.valueOf(HttpStatus.BAD_REQUEST);
                httpStatusMsgReturn = Constant.GEN_ERR_MSG;
                response = Response.generateResponse(Constant.GEN_ERR_MSG, HttpStatus.BAD_REQUEST, null);
            } else {
                InvestmentsAndSavingsDay responses = investmentsAndSavingsDayService.updateInvestmentsAndSavingsDay(investmentsAndSavingsDay, id);
                httpStatusReturn = String.valueOf(HttpStatus.OK);
                httpStatusMsgReturn = Constant.SUCCESS;
                response = Response.generateResponse(Constant.SUCCESS, HttpStatus.OK, responses);
            }
            ...
            requestLogs.setRequestMethod(new Exception().getStackTrace()[0].getMethodName());
            requestLogs.setEndpoint(endPoint);
            requestLogs.setRequestDetails(investmentsAndSavingsDay.toString() + " PathVariable id: " + id);
            requestLogs.setRequestResponse(Objects.requireNonNull(body).toString());
            requestLogs.setStatusCode(Integer.parseInt(httpStatusReturn.replaceAll("\\D+", "")));
            requestLogs.setStatusResponse(httpStatusMsgReturn);
            requestLogs.setTimestamp((String) body.get("timestamp"));
    ...
    @DeleteMapping("/investmentsandsavingsday/delete/{id}")
    public ResponseEntity<Object> deleteInvestmentsAndSavingsDay(@PathVariable Long id, HttpServletRequest httpServletRequest) {
        String endPoint = httpServletRequest.getServerName() + URL + "/investmentsandsavingsday/delete/" + id;
        try {
            ...
            if (existing.isEmpty()) {
                ...
                investmentsAndSavingsDayService.deleteInvestmentsAndSavingsDay(id);
                httpStatusReturn = String.valueOf(HttpStatus.OK);
                httpStatusMsgReturn = Constant.SUCCESS;
